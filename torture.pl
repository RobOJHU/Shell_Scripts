# The main body of torture.pl

#!/usr/local/bin/perl
 
# file: torture.pl
# Torture test Web servers and scripts.
...
#The do_stats() function is responsible for launching the timing tests
...
# The code for run_test() and its helpers, random_string() and escape()
...
# The fetch() routine retrieves the contents of any URL
